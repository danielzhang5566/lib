...
var God = {
    ...
    getQueryString: function (callback) {
        ...
        try {
            ...
            me.sendMsg('S521', 'shareInfoErr' + e.message);
            window.location = './index.html'
        }
        ...
        wx.ready(function () {
            ...
            wx.onMenuShareTimeline({
                ...
                success: function () {
                    // 用户确认分享后执行的回调函数
                    //console.log('分享成功')
                    me.sendMsg('S121', 'onMenuShareTimeline')
                },
                cancel: function () {
                    // 用户取消分享后执行的回调函数
                }
            ...
            wx.onMenuShareAppMessage({
                ...
                success: function () {
                    // 用户确认分享后执行的回调函数
                    //console.log('分享成功')
                    me.sendMsg('S221', 'onMenuShareAppMessage')
                },
                cancel: function () {
                    // 用户取消分享后执行的回调函数
                }
